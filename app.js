...
const gradeOptions = [
  ...
  ,
  {
    ...
    unit: "الحضارات القديمة",
    keywords: ["الحضارة الرومانية", "حضارة الرومان", "الرومان", "الرومانية", "روما", "الإمبراطورية الرومانية"],
    explanation: "الحضارة الرومانية حضارة قديمة نشأت في مدينة روما، وتميّزت بقوة الدولة والتنظيم الإداري والقانون والجيش والعمارة، وانتقلت من مملكة إلى جمهورية ثم إمبراطورية، وتركت أثرًا كبيرًا في القوانين والطرق والمدن واللغة اللاتينية.",
    steps: [
      "تحديد مكان النشأة: مدينة روما في شبه الجزيرة الإيطالية.",
      "ذكر أبرز السمات: القانون، الجيش، الإدارة، الطرق، والعمارة.",
      "توضيح أثرها التاريخي في أوروبا وحوض البحر المتوسط."
    ],
    mistakes: [
      "الخلط بين الحضارة الرومانية والحضارة اليونانية.",
      "اعتبار الرومان مجرد شعب واحد دون فهم تطور الدولة من جمهورية إلى إمبراطورية."
    ],
    similar: "ما أبرز إنجازات الحضارة الرومانية؟"
  },
  {
    subject: "الاجتماعيات",
    lesson: "الحضارة اليونانية",
    unit: "الحضارات القديمة",
    keywords: ["الحضارة اليونانية", "حضارة اليونان", "اليونان", "اليونانية", "أثينا", "اسبرطة", "أسبرطة"],
    explanation: "الحضارة اليونانية حضارة قديمة ازدهرت في بلاد اليونان، واشتهرت بالفلسفة والعلوم والفنون والمسرح ونظام المدينة الدولة مثل أثينا وإسبرطة، وكان لها تأثير كبير في الفكر والسياسة والثقافة.",
    steps: [
      "تحديد موطن الحضارة في بلاد اليونان.",
      "ذكر أهم المظاهر: الفلسفة، الفنون، العلوم، والمسرح.",
      "توضيح أثر المدينة الدولة مثل أثينا وإسبرطة."
    ],
    mistakes: [
      "حصر الحضارة اليونانية في مدينة واحدة فقط.",
      "الخلط بين إنجازات اليونان وإنجازات الرومان."
    ],
    similar: "ما الفرق بين الحضارة اليونانية والحضارة الرومانية؟"
  },
  {
    subject: "العلوم",
    lesson: "مرض كورونا",
    unit: "الصحة والأمراض",
    keywords: ["كورونا", "كورنا", "كوفيد", "فيروس كورونا", "مرض كورونا", "covid", "covid-19"],
    explanation: "مرض كورونا أو كوفيد-19 هو مرض معدٍ سببه فيروس كورونا المستجد، وقد يسبب أعراضًا تنفسية مثل الحمى والسعال والتعب وضيق التنفس، وتختلف شدته من حالة خفيفة إلى شديدة، وتساعد النظافة والتهوية واللقاحات في تقليل انتشاره ومضاعفاته.",
    steps: [
      "تحديد سبب المرض: فيروس كورونا المستجد.",
      "ذكر الأعراض الشائعة مثل الحمى والسعال وضيق التنفس.",
      "توضيح أن الوقاية تكون بالنظافة والتهوية واللقاحات حسب الإرشادات الصحية."
    ],
    mistakes: [
      "اعتبار كورونا مسألة رياضيات أو موضوعًا غير صحي.",
      "الجزم بأن كل الإصابات تكون شديدة؛ فبعضها خفيف وبعضها شديد."
    ],
    similar: "ما أعراض مرض كورونا وكيف يمكن الوقاية منه؟"
  },
  {
    subject: "الرياضيات",
    lesson: "الضرب",
    unit: "العمليات الحسابية",
    keywords: ["كيف نضرب", "الضرب", "جدول الضرب", "نضرب", "عملية الضرب"],
    explanation: "الضرب هو جمع متكرر للعدد نفسه. مثلًا 4 × 3 تعني 4 + 4 + 4 أو 3 + 3 + 3 + 3، والناتج 12. ولتعلم الضرب بسرعة نبدأ بفهم الفكرة ثم حفظ الجداول والتدرب على أمثلة قصيرة.",
    steps: [
      "افهم أن الضرب يعني تكرار الجمع.",
      "اكتب مثالًا بسيطًا وحوله إلى جمع متكرر.",
      "احفظ جدول الضرب وتدرّب على عمليات قصيرة يوميًا."
    ],
    mistakes: [
      "حفظ النتيجة دون فهم معنى الضرب.",
      "الخلط بين ترتيب التكرار ومعنى العملية في البداية."
    ],
    similar: "كيف أحسب 6 × 7 بطريقة سهلة؟"
  }
];
...
for (let gradeIndex = gradeOptions.length - 1; gradeIndex >= 0; gradeIndex -= 1) {
  if (typeof gradeOptions[gradeIndex] !== "string") {
    gradeOptions.splice(gradeIndex, 1);
  }
}
...
knowledgeBase.push(
  {
    ...
    unit: "الحضارات القديمة",
    keywords: ["الحضارة الرومانية", "حضارة الرومان", "الرومان", "الرومانية", "روما", "الإمبراطورية الرومانية"],
    explanation: "الحضارة الرومانية حضارة قديمة نشأت في مدينة روما، واشتهرت بتنظيم الدولة والقانون والجيش والطرق والعمارة، وتطورت من مملكة إلى جمهورية ثم إمبراطورية، وتركت أثرًا كبيرًا في أنظمة الحكم والقوانين واللغة اللاتينية.",
    steps: [
      "تحديد مكان النشأة: مدينة روما في شبه الجزيرة الإيطالية.",
      "ذكر أبرز السمات: القانون، الإدارة، الجيش، الطرق، والعمارة.",
      "توضيح أثرها التاريخي في أوروبا وحوض البحر المتوسط."
    ],
    mistakes: [
      "الخلط بين الحضارة الرومانية والحضارة اليونانية.",
      "اعتبار الرومان مجرد مدينة واحدة فقط دون فهم تطور الدولة إلى إمبراطورية واسعة."
    ],
    similar: "ما أبرز إنجازات الحضارة الرومانية؟"
  },
  {
    ...
    lesson: "الحضارة اليونانية",
    unit: "الحضارات القديمة",
    keywords: ["الحضارة اليونانية", "حضارة اليونان", "اليونان", "اليونانية", "أثينا", "إسبرطة", "اسبرطة"],
    explanation: "الحضارة اليونانية حضارة قديمة ازدهرت في بلاد اليونان، واشتهرت بالفلسفة والعلوم والفنون والمسرح ونظام المدينة الدولة مثل أثينا وإسبرطة، وكان لها تأثير كبير في الفكر والسياسة والثقافة.",
    steps: [
      "تحديد موطن الحضارة في بلاد اليونان.",
      "ذكر أهم المظاهر: الفلسفة، الفنون، العلوم، والمسرح.",
      "توضيح دور المدينة الدولة مثل أثينا وإسبرطة."
    ],
    mistakes: [
      "حصر الحضارة اليونانية في مدينة واحدة فقط.",
      "الخلط بين إنجازات اليونان وإنجازات الرومان."
  ...
  },
  {
    ...
    unit: "الصحة والأمراض",
    keywords: ["كورونا", "كورنا", "كوفيد", "فيروس كورونا", "مرض كورونا", "covid", "covid-19"],
    explanation: "مرض كورونا أو كوفيد-19 هو مرض معدٍ يسببه فيروس كورونا المستجد، وقد يسبب أعراضًا تنفسية مثل الحمى والسعال والتعب وضيق التنفس، وتختلف شدته من حالة خفيفة إلى شديدة، وتساعد التهوية والنظافة واللقاحات في تقليل انتشاره ومضاعفاته.",
    steps: [
      "تحديد سبب المرض: فيروس كورونا المستجد.",
      "ذكر الأعراض الشائعة مثل الحمى والسعال وضيق التنفس.",
      "توضيح أن الوقاية تكون بالنظافة والتهوية واللقاحات حسب الإرشادات الصحية."
    ...
    mistakes: [
      "اعتبار كورونا مسألة رياضيات أو موضوعًا غير صحي.",
      "الجزم بأن كل الإصابات تكون شديدة، بينما بعضها خفيف وبعضها شديد."
    ],
    similar: "ما أعراض مرض كورونا وكيف يمكن الوقاية منه؟"
  },
  {
    ...
    steps: [
      "افهم أن الضرب يعني تكرار الجمع.",
      "اكتب مثالًا بسيطًا وحوّله إلى جمع متكرر.",
      "احفظ جدول الضرب وتدرّب على عمليات قصيرة يوميًا."
    ],
    mistakes: [
      "حفظ النتيجة دون فهم معنى الضرب.",
...
subjectKeywordMap["الكيمياء"] = [
  ...new Set([
    ...(subjectKeywordMap["الكيمياء"] || []).filter((keyword) => !["na", "cl"].includes(normalizeText(keyword))),
    "nacl",
    "sodium chloride",
    "الصوديوم",
    "الكلور"
...
detectQuestionType = function patchedDetectQuestionType(text) {
  const source = String(text || "");
  const normalized = normalizeText(source);

  if (/صواب|صح|خطأ|true|false/i.test(normalized)) return "صح وخطأ";
  if (/match\b|طابق/i.test(source) || /match\b|طابق/i.test(normalized)) return "مطابقة";
  if (/_{2,}|\.{3,}/.test(source) || /\(go\)|\(write\)|\(play\)/i.test(source)) return "إكمال فراغ";
  if (/أ\)|ب\)|ج\)|د\)|اختيار من متعدد|اختر|•/.test(source) || /\s+-\s+/.test(source)) return "اختيار من متعدد";
  if (/^\s*\d+\s*[x×*\/+\-]\s*\d+\s*[=؟?]?\s*$/.test(source) || /احسب|أوجد|حل المعادلة|مساحة|محيط|\d/.test(normalized)) return "مسألة";
  if (/عرف|ماهو|ماهي|ما هو|ما هي|ماذا يعني|ما المقصود|what is|define/i.test(normalized)) return "تعريف";
  if (/قارن|الفرق بين|وازن بين/.test(normalized)) return "مقارنة";
  if (/اشرح|فسر|وضح|بحث|سوي بحث|بحث شامل/i.test(normalized)) return "شرح";
  return "سؤال أكاديمي";
};
...
retrieveCurriculumContext = function patchedRetrieveCurriculumContext(question, preferredSubject = "") {
  const context = getCurrentContext();
  const subjectFromLesson = knowledgeBase.find((entry) =>
    normalizeText(question).includes(normalizeText(entry.subject))
  )?.subject || "";
  const detectedSubject = detectSubjectFromContent(question);
  const inferredSubject = preferredSubject || subjectFromLesson || detectedSubject || "";
  const lesson = findLesson(question, inferredSubject);
  const finalSubject = lesson?.subject || inferredSubject || "";

  return {
    grade: context.grade,
    subject: finalSubject || "عام",
    term: context.term,
    lesson: lesson?.lesson || context.lesson || (finalSubject ? "غير محدد" : ""),
    unit: lesson?.unit || (finalSubject ? "منهج المادة" : "مصدر عام"),
    entry: lesson || null
  };
};
